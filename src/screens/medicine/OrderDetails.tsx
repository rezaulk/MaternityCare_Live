...
const OrderDetails = ({ navigation }: { navigation: any }) => {
  ...
  useEffect(() => {
    ...
    var roundingoff = Number(
      subtotalPrice - discountApply - Math.floor(subtotalPrice - discountApply)
    ).toFixed(2);
